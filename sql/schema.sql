...
CREATE TABLE IF NOT EXISTS recaudos (
    ...
    regional VARCHAR(80) NULL,
    tipo_documento_aplicado VARCHAR(50) NULL,
    nro_documento_aplicado VARCHAR(80) NULL,
    documento_uid VARCHAR(180) NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    INDEX idx_recaudos_periodo (periodo_carga),
    INDEX idx_recaudos_recibo (nro_recibo),
    INDEX idx_recaudos_documento_uid (documento_uid),
...
CREATE TABLE IF NOT EXISTS recaudo_aplicacion (
    ...
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    INDEX idx_recaudo_aplicacion_documento_uid (documento_uid),
